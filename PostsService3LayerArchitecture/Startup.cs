...
using BusinessLogic.Services.Implimentation;
using BusinessLogic.Services.Interfaces;
using DataAccessLayer.Repositories.Implimentation;
...
namespace PostsService3LayerArchitectureHost
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Posts Service 3-Layer Architecture API", Version = "v1" });
            });
        }
